...
$mhs = query("SELECT * FROM dosen_pengampu WHERE NIP_Dosen = $NIP_Dosen")[0];
...
<head>
    ...
    <title>Ubah data dosen_pengampu</title>
...
<body>
    ...
    <form action="" method="post">
        <input type="hidden" name="id" value="<?= $mhs["NIP_Dosen"]; ?>">
        <ul>
            <li>
                <label for="NIP_Dosen">NIP_Dosen</label><br>
                <input type="text" name="NIP_Dosen" id="NIP_Dosen" require value="<?= $mhs["NIP_Dosen"]; ?>">
            </li>
            <br>
            <li>
                <label for="Nama_Dosen">Nama_Dosen</label><br>
                <input type="text" name="Nama_Dosen" id="Nama_Dosen" require value="<?= $mhs["Nama_Dosen"]; ?>">
            </li>
            <br>
            <li>
