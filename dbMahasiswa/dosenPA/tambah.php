...
<head>
    ...
    <title>Tambah data dosen pa</title>
    ...
    <!-- css -->
    <link rel="stylesheet" href="tambahPA.css" />
...
<body>
    ...
    <h1>Tambah Data Dosen PA</h1>

    <form action="" method="post">
        <ul>
            <li>
                <label for="Kode_PA">Kode_PA</label><br><br>
                <input type="text" name="Kode_PA" id="Kode_PA">
            </li>
            <br>
            <li>
                <label for="Nama_PA">Nama_PA</label> <br>
                <input type="text" name="Nama_PA" id="Nama_PA">
            </li>
            <br>
            <li>
