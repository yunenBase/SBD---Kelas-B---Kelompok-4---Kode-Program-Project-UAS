...
$mhs = query("SELECT * FROM matakuliah WHERE Kode_MK = $Kode_MK")[0];
...
<body>
    ...
    <form action="" method="post">
        <input type="hidden" name="id" value="<?= $mhs["Kode_MK"]; ?>">
        <ul>
            <li>
                <label for="Kode_MK">Kode_MK</label><br>
                <input type="text" name="Kode_MK" id="Kode_MK" require value="<?= $mhs["Kode_MK"]; ?>">
            </li>
            <br>
            <li>
                <label for="Nama_MK">Nama_MK</label><br>
                <input type="text" name="Nama_MK" id="Nama_MK" require value="<?= $mhs["Nama_MK"]; ?>">
            </li>
            <br>
            <li>
                <label for="SKS">SKS</label><br>
                <input type="text" name="SKS" id="SKS" require value="<?= $mhs["SKS"]; ?>">
            </li>
            <br>
            <li>
                <label for="Jadwal">Jadwal</label><br>
                <input type="text" name="Jadwal" id="Jadwal" require value="<?= $mhs["Jadwal"]; ?>">
            </li>
            <br>
            <li>
                <label for="Ruangan">Ruangan</label><br>
                <input type="text" name="Ruangan" id="Ruangan" require value="<?= $mhs["Ruangan"]; ?>">
            </li>
            <br>
            <li>
                <label for="Kelas">Kelas</label><br>
                <input type="text" name="Kelas" id="Kelas" require value="<?= $mhs["Kelas"]; ?>">
            </li>
            <br>
            <li>
